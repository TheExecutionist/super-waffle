...
case 'k': { // key verification DEV SERVER
    ...
    if (allowed.indexOf(key) != -1 || !c.TOKEN_REQUIRED) {
        // Save the key
...
var BT = [
	...
	case '0': {//Developer cheat
 		if (m.length !== 0) { socket.kick('Ill-sized testbed request.'); return 1; }
                    ...
                    // cheatingbois
                    if (player.body != null) { if (socket.key === "ALPHATANK" | "ArrasianDev" | "ArrasianLore" | "KingArras2") {
...
var prefix = process.env.prefix2
